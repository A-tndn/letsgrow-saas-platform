  ...
  plugins: [
    ...
    function({ addComponents, theme }) {
      addComponents({
        ...
        '.platform-card': {
          '@apply relative overflow-hidden rounded-lg bg-white p-4 shadow-soft transition-all duration-200 hover:shadow-medium': {},
        },
        '.metric-card': {
          '@apply rounded-lg border border-gray-200 bg-white p-6 shadow-soft': {},
        },
        '.gradient-text': {
